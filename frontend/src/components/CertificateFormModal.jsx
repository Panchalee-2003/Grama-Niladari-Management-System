...
function ResidenceCharacterForm({ data, onChange }) {
  return (
    <>
      ...
      <TextField
        label="District and Divisional Secretary's Division"
        name="district_division"
        value={data.district_division}
        onChange={onChange}
      />
      <TextField
        label="Grama Niladhari Division and Number"
        name="gn_division_number"
        value={data.gn_division_number}
        onChange={onChange}
      />
      <SelectField
        label="Applicant personally known to Grama Niladhari?"
        name="personally_known"
        value={data.personally_known}
        onChange={onChange}
        options={["Yes", "No"]}
      />
      <TextField
        label="If yes, since when"
        name="known_since"
        value={data.known_since}
        onChange={onChange}
      ...
      <SelectField
        label="Whether Sri Lankan"
        name="sri_lankan"
        value={data.sri_lankan}
        onChange={onChange}
        options={["Yes", "No"]}
      />
      <TextField
      ...
      />
      <TextField
        label="Period of residence in the village"
        name="residence_period"
        value={data.residence_period}
        onChange={onChange}
      />
      <TextField
      ...
      />
      <TextField
        label="Number of the Electoral Register and Particulars of Registration"
        name="electoral_no"
        value={data.electoral_no}
        onChange={onChange}
      />
      <TextField
        label="Name and Address of the Father"
        name="father_name_address"
        value={data.father_name_address}
        onChange={onChange}
      />
      <TextField
      ...
      <TextField
        label="Period of residence in the Grama Niladhari Division"
        name="gn_residence_period"
        value={data.gn_residence_period}
        onChange={onChange}
      />
      <TextField
        label="Nature of other evidences in proof of the period of residence"
        name="evidence_nature"
        value={data.evidence_nature}
        onChange={onChange}
      />
      <SelectField
        label="Whether the Applicant has been convicted by a Court of Law?"
        name="convicted"
      ...
      />
      <SelectField
        label="Taken interest in public activities, social service work, community work, etc.?"
        name="public_activities"
        value={data.public_activities}
        onChange={onChange}
        options={["Yes", "No"]}
      />
      <TextField
        label="His/her character"
        name="character"
      ...
      />
      <TextField
        label="Grama Niladhari Name"
        name="gn_name"
        value={data.gn_name}
        onChange={onChange}
      />
      <TextField
        label="Divisional Secretary Name"
        name="div_secretary"
        value={data.div_secretary}
        onChange={onChange}
      />
    </>
  );
...
function IncomeForm({ data, onChange }) {
  return (
    <>
      ...
      />
      <TextField
        label="2. National Identity Card (NIC) Number"
        name="nic"
        value={data.nic}
        onChange={onChange}
      />
      <TextField
        label="3. Residential Address"
        name="address"
        value={data.address}
        onChange={onChange}
      />
      ...
      />
      <TextField
        label="5. Village / Street"
        name="village_street"
        value={data.village_street}
        onChange={onChange}
      />
      <TextField
        label="6. Grama Niladhari Division"
        name="gn_division"
        value={data.gn_division}
        onChange={onChange}
      />
      <TextField
        label="7. Samurdhi or other relief/allowances received"
        name="samurdhi"
        value={data.samurdhi}
        onChange={onChange}
      />
      <TextField
        label="8. Purpose for which the Income Certificate is required"
        name="purpose"
        value={data.purpose}
        onChange={onChange}
      />
      ...
      <TextField
        label="9. Source of Income"
        name="income_source"
        value={data.income_source}
        onChange={onChange}
      />
      <TextField
        label="10. Registration of Income Source"
        name="income_reg"
        value={data.income_reg}
        onChange={onChange}
      />
      <TextField
        label="11. Address of income source location"
        name="income_address"
        value={data.income_address}
        onChange={onChange}
      />
      <TextField
        label="12. Period of engagement in income source/business"
        name="income_period"
        value={data.income_period}
        onChange={onChange}
      />
      <SelectField
        label="13. Will you continue to be engaged in this income source?"
        name="continue_income"
        value={data.continue_income}
        onChange={onChange}
        options={["Yes", "No"]}
      />
      <SelectField
        label="14. Any objection from the owner regarding income certificate based on monthly salary?"
        name="employer_objection"
        value={data.employer_objection}
        onChange={onChange}
        options={["No", "Yes"]}
      />
      <SelectField
        label="15. Is tax paid for the income mentioned?"
        name="tax_paid"
        value={data.tax_paid}
        onChange={onChange}
        options={["No", "Yes"]}
      />
      <SelectField
        label="16. Has the applicant obtained an income certificate within the last 06 months?"
        name="previous_cert"
        value={data.previous_cert}
        onChange={onChange}
        options={["No", "Yes"]}
      />
      <TextField
        label="17. If so, what was the amount of that income?"
        name="previous_income"
        value={data.previous_income}
        onChange={onChange}
      />
      <TextField
        label="18. Other facts"
        name="other_facts"
        value={data.other_facts}
        onChange={onChange}
        multiline
      />
      ...
      <TextField
        label="19. Recommended Monthly Income / Annual Income (Rs.)"
        name="recommended_income"
        value={data.recommended_income}
        onChange={onChange}
        required
      />
      <TextField
        label="Grama Niladhari Name & Division"
        name="gn_name"
        value={data.gn_name}
        onChange={onChange}
      />
...
function HousingLoanForm({ data, onChange }) {
  return (
    <>
      ...
      />
      <TextField
        label="03. Monthly Family Income (Rs.)"
        name="monthly_income"
        value={data.monthly_income}
        onChange={onChange}
      />
      <SelectField
        label="04. Whether a Samurdhi Beneficiary"
        name="samurdhi_beneficiary"
        value={data.samurdhi_beneficiary}
        onChange={onChange}
        options={["No", "Yes"]}
      />
      ...
      <TextField
        label="Description of Property (Land/Property)"
      ...
      <TextField
        ...
        name="extent_of_land"
        value={data.extent_of_land}
        onChange={onChange}
      />
      <TextField
        label="Deed Number and Date"
        name="deed_number_date"
        value={data.deed_number_date}
        onChange={onChange}
      />

      <SectionTitle>Section 3: Applicant's Declaration</SectionTitle>
      <TextField
        label="Loan/Grant Amount Requested (Rs.)"
        name="loan_amount"
      ...
      <TextField
        label="Housing Officer Name & Division"
        name="housing_officer"
        value={data.housing_officer}
        onChange={onChange}
      />

      <SectionTitle>Section 6: Approval of Divisional Secretary</SectionTitle>
      <TextField
        label="Divisional Secretary Name & Division"
        name="div_secretary"
        value={data.div_secretary}
        onChange={onChange}
      />
...
function BirthCertForm({ data, onChange }) {
  return (
    <>
      ...
      />
      <TextField
        label="4i. National Identity Card (NIC) No."
        name="nic"
        value={data.nic}
        onChange={onChange}
      />
      <TextField
        label="4ii. Passport No."
        name="passport_no"
        value={data.passport_no}
        onChange={onChange}
      />
      <TextField
        label="4iii. Driving License No."
      ...
      <TextField
        label="6. Name of person who submitted declaration"
        name="known_person"
        value={data.known_person}
        onChange={onChange}
      />
      <TextField
        label="7. Name of person born"
        name="born_person"
        value={data.born_person}
        onChange={onChange}
      />
      <TextField
        label="   Born at (Hospital / Maternity Home / House named)"
        name="born_place"
        value={data.born_place}
        onChange={onChange}
      />
      <TextField
        label="8. Father's Name"
        name="father_name"
      ...
      />
      <TextField
        label="9. This birth is reported under"
        name="reported_under"
        value={data.reported_under}
        onChange={onChange}
      />
...
function DeathPensionerForm({ data, onChange }) {
  const [dependents, setDependents] = useState(
    data.dependents || [{ name: "", relationship: "", age: "" }],
  );

  const updateDependent = (i, field, val) => {
    const updated = dependents.map((d, idx) =>
      idx === i ? { ...d, [field]: val } : d,
    );
  ...
  return (
    <>
      ...
      <TextField
        label="1. Name of the Pensioner"
        name="pensioner_name"
        value={data.pensioner_name}
        onChange={onChange}
        required
      />
      <TextField
      ...
      />
      <TextField
        label="4. National Identity Card (NIC) Number"
        name="nic"
        value={data.nic}
        onChange={onChange}
      />
      <TextField
        label="5. Pension Number"
        name="pension_number"
      ...
      <div className="cf-dependents-table">
        <div className="cf-dep-header">
          <span>No.</span>
          <span>Name</span>
          <span>Relationship to Pensioner</span>
          <span>Age</span>
          <span></span>
        </div>
        {dependents.map((dep, i) => (
          <div className="cf-dep-row" key={i}>
            ...
            <input
              className="cf-input cf-dep-input"
              placeholder="Name"
              value={dep.name}
            ...
            />
            <input
              className="cf-input cf-dep-input cf-dep-age"
              placeholder="Age"
              value={dep.age}
        ...
        <button type="button" className="cf-dep-add" onClick={addDependent}>
          + Add Dependent
        </button>
      </div>
...
const FORM_LABELS = {
  ...
  "Registration of delayed births":
    "Registration of Delayed Births – GN Report",
  "Request for financial assistance from the President's fund for medical treatment":
    "Request for Medical Financial Assistance",
...
export default function CertificateFormModal({ request, onClose }) {
  ...
  useEffect(() => {
    if (!request) return;
    api
      .get(`/api/certificate/${request.request_id}/data`)
      .then((r) => {
  ...
  const handleSave = async () => {
    ...
    setError("");
    try {
      await api.patch(`/api/certificate/${request.request_id}/data`, {
  ...
  const handleGeneratePDF = async () => {
    ...
    try {
      ...
      const response = await api.get(
        `/api/certificate/${request.request_id}/pdf`,
        {
          responseType: "blob",
        },
      );
  ...
  return (
    <div className="cf-overlay" onClick={onClose}>
      <div className="cf-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="cf-modal-header">
          <div>
            ...
            <h2 className="cf-modal-title">
              {FORM_LABELS[request.cert_type] || request.cert_type}
            </h2>
        ...
        {/* Form body */}
        <div className="cf-body">{renderForm()}</div>
        ...
        {certInfo?.certificate_id && (
          <div className="cf-cert-info">
            ...
            <div className="cf-cert-id">
              ID: <code>{certInfo.certificate_id}</code>
            </div>
        ...
        {/* Messages */}
        {saveSuccess && (
          <div className="cf-success">✓ Form data saved successfully.</div>
        )}
        ...
        <div className="cf-footer">
          ...
          <button
            className="cf-btn cf-btn-generate"
            onClick={handleGeneratePDF}
            disabled={generating}
          >
            {generating ? "Generating…" : "📄 Generate & Download PDF"}
          </button>
          <button className="cf-btn cf-btn-cancel" onClick={onClose}>
            Cancel
          </button>
        </div>
      </div>
