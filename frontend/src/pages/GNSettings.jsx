...
function IconGlobe() { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2"/><path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" stroke="currentColor" strokeWidth="2"/></svg>; }
function IconPalette() { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z" stroke="currentColor" strokeWidth="2"/><path d="M12 22.14a4.48 4.48 0 0 0-4.47-4.48 4.48 4.48 0 0 1-4.47-4.47" stroke="currentColor" strokeWidth="2"/></svg>; }
    ...
    <div className="gn-wrap">
      ...
      <aside className="gn-sidebar">
        ...
        <nav className="gn-menu">
          ...
          <Link to="/gn-certificates" className="gn-item"><span className="gn-ico"><IconDoc /></span><span>Certificates</span></Link>
        ...
        <div className="gn-settings">
          <Link to="/gn/settings" className="gn-item gn-item-settings gn-item-active">
          ...
          <div className="settings-grid">
            ...
            <div className="settings-card">
              <div className="settings-card-title">
                <div className="settings-icon-wrap"><IconGlobe /></div>
                Preferred Language
              </div>
              ...
              <p style={{fontSize:"13px", color:"#777", marginTop:"10px"}}>
                Choosing a language will change the system labels and notifications.
              </p>
            </div>
            ...
            <div className="settings-card">
              <div className="settings-card-title">
                <div className="settings-icon-wrap"><IconPalette /></div>
              ...
              <div className="settings-form-group">
                ...
                <div style={{display:"flex", gap:"10px", alignItems:"center"}}>
                  <input 
                    ...
                    style={{width:"44px", height:"44px", padding:"2px", border:"1px solid #ddd", borderRadius:"8px", cursor:"pointer"}}
                  />
                  <input 
                    type="text" 
              ...
              <div className="settings-form-group">
                ...
                <button 
                  ...
                  onClick={() => setBgColor(bgColor === "#1a1a1a" ? "#ffffff" : "#1a1a1a")}
                >
                  {bgColor === "#1a1a1a" ? "Switch to Light Mode" : "Switch to Dark Mode"}
                </button>
              </div>
            </div>
            ...
            <div className="settings-card">
              <div className="settings-card-title">
                <div className="settings-icon-wrap"><IconPeople /></div>
                Account Information
              </div>
              <div className="settings-form-group">
                <label className="settings-label">Registered Name</label>
                <input className="settings-input" value="J.A. Jayawardena" readOnly />
              </div>
              <div className="settings-form-group">
                <label className="settings-label">Grama Niladhari Division</label>
                <input className="settings-input" value="Maspanna (GN 12)" readOnly />
              </div>
            ...
            <div className="settings-card">
              <div className="settings-card-title">
                <div className="settings-icon-wrap"><IconBell /></div>
                Notification Preferences
              </div>
              <div className="settings-form-group">
                <div style={{display:"flex", alignItems:"center", gap:"10px", padding:"8px 0"}}>
                   <input type="checkbox" id="email-notif" defaultChecked />
                   <label htmlFor="email-notif" className="settings-label" style={{margin:0}}>Email alerts for new certificate requests</label>
                </div>
                <div style={{display:"flex", alignItems:"center", gap:"10px", padding:"8px 0"}}>
                   <input type="checkbox" id="sms-notif" />
                   <label htmlFor="sms-notif" className="settings-label" style={{margin:0}}>SMS alerts for urgent complaints</label>
                </div>
              </div>
              <button 
