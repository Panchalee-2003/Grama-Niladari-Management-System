...
export default function AboutUs() {
  ...
  const services = [
    ...
    {
      id: "03",
      name: "Issuing Volunteer certificate",
      provider: "GN",
      providedBy: "Giving recommendation to Divisional Secretary",
      maxTime: "02 days",
    },
    {
      id: "04",
    ...
    {
      id: "05",
      name: "Certifying documents and applications",
      provider: "GN",
      providedBy: "Grama Niladhari",
      maxTime: "01 day",
    },
    {
      id: "06",
      name: "Cutting jack trees",
      provider: "GN",
      providedBy: "To divisional secretary",
      maxTime: "01 day",
    },
    {
      id: "07",
      name: "Permits for timber transportation",
      provider: "GN",
      providedBy: "Giving recommendation to Divisional Secretary",
      maxTime: "02 days",
    },
    {
      id: "08",
      name: "Issuing permits for felling trees",
      provider: "GN",
      providedBy: "Giving recommendation to Divisional Secretary",
      maxTime: "02 days",
    },
    ...
    {
      id: "10",
      name: "Providing report on death persons",
      provider: "GN",
      providedBy: "Report of natural death",
      maxTime: "03 hours",
    },
    {
      id: "11",
      name: "Issuing permits for vehicles",
      provider: "GN",
      providedBy: "Grama Niladhari",
      maxTime: "01 day",
    },
    {
      id: "12",
      name: "Giving reports of complaints",
      provider: "GN",
      providedBy: "Grama Niladhari",
      maxTime: "07 days",
    },
    {
      id: "13",
      name: "Recommendation for public aids",
      provider: "GN",
      providedBy: "Giving recommendation to Divisional Secretary",
      maxTime: "03 days",
    },
    {
      id: "14",
      name: "Registration of land deeds",
      provider: "GN",
      providedBy: "Grama Niladhari",
      maxTime: "03 days",
    },
    {
      id: "15",
      name: "Providing information for scholarship",
      provider: "GN",
      providedBy: "Giving recommendation to Divisional Secretary",
      maxTime: "03 days",
    },
    {
      id: "16",
      name: "Aids on presidential funds",
      provider: "GN",
      providedBy: "Giving recommendation to Divisional Secretary",
      maxTime: "02 days",
    },
    ...
    <div className="au-page">
      ...
      <header className="au-top">
        ...
        <div className="au-top-actions">
          <Link to="/about" className="au-about-btn">
            About Us
          </Link>
        ...
        >
          <div className="au-hero-content">
            <div className="au-vision-card">
              <h2>Our Vision</h2>
              <p>
                To provide efficient and fruitful state service to the customer.
              </p>
            </div>
            ...
            <div className="au-mission-card">
              <h2>Our Mission</h2>
              <p>
                To assure an efficient and fruitful state service which fulfill
                the desires of the people through the government policy and the
                proper administrative structure and ensure resources
                coordination.
              </p>
            </div>
          </div>
