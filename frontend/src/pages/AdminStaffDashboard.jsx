  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        setDivisions(gnDivisionsList.map(div => ({
          name: div,
          pendingRequests: 0
        })));
      } finally {
      ...
      <header className="ds-top">
        <div className="ds-brand">
          ...
          <div className="ds-brand-text">
            <div className="ds-title">Divisional Secretariat - Uva Paranagama</div>
            <div className="ds-subtitle">Ministry of Home Affairs & Public Administration</div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="ds-grid">
            {filteredDivisions.length > 0 ? (
                ...
                <div key={index} className="ds-card">
                  <div className="ds-card-header">
                    ...
                    {div.pendingRequests > 0 && (
                      <span className="ds-badge">{div.pendingRequests} Pending</span>
                    )}
                    {div.pendingRequests === 0 && (
              ...
              <div className="ds-no-results">No divisions found matching "{searchQuery}"</div>
            )}
          </div>
        )}
      </main>
