...
function IconCoin() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
      <path
        d="M12 20c4.418 0 8-1.79 8-4s-3.582-4-8-4-8 1.79-8 4 3.582 4 8 4Z"
        stroke="#0b0b0b"
        strokeWidth="2"
      />
      <path d="M4 16V8M20 16V8" stroke="#0b0b0b" strokeWidth="2" />
      <path
      ...
      <section className="pn-main">
        ...
        <div className="pn-content">
          ...
          <form className="pn-form" onSubmit={handleSubmit}>
            {submitSuccess && (
              <div className="pn-alert pn-alert-ok">{submitSuccess}</div>
            )}
            {submitError && (
              <div className="pn-alert pn-alert-err">{submitError}</div>
            )}

            <div className="pn-field">
              <div className="pn-label">
                Title <span className="pn-req">*</span>
              </div>
              <input
                className="pn-input"
            ...
            <div className="pn-field">
              ...
              <label className="pn-upload">
                <input
                  id="notice-img-input"
                  className="pn-upload-input"
                  type="file"
                  accept="image/*"
                  onChange={handleImageChange}
                />
                <span className="pn-upload-icon">
                  <IconUpload />
                </span>
                <span className="pn-upload-text">
          ...
          {listError && (
            <div className="pn-state pn-state-err">{listError}</div>
          )}
          {!listLoading && notices.length === 0 && (
            <div className="pn-state">No notices posted yet.</div>
          )}
            ...
            <div className="pn-table">
              ...
              {notices.map((n) => (
                <div className="pn-row" key={n.notice_id}>
                  ...
                  <div className="pn-cell pn-muted pn-cell-desc">
                    {n.description || "—"}
                  </div>
                  <div className="pn-cell pn-muted">
                    {n.notice_date
