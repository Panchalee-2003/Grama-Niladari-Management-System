...
export default function SignUp() {
  ...
  function handleBlur(field) {
    ...
    if (field === "confirmPassword")
      err = validateConfirm(form.password, form.confirmPassword);
  ...
  return (
    ...
    >
      <h2 className="sub-title" style={{ marginBottom: 2 }}>
        Create Account
      </h2>
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        {/* ── Submit ────────────────────────────────────────────────── */}
        <button className="btn-main" type="submit" style={{ marginTop: 18 }}>
          Create Account
        </button>
