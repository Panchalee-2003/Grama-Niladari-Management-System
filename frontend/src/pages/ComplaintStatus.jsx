    ...
    <div className="cst-page">
      ...
      <main className="cst-main">
        <div className="cst-header-row">
          ...
          <Link to="/complaints" className="cst-new-btn">
            + New Complaint
          </Link>
        </div>
              ...
              return (
                <div key={c.complaint_id}>
                  <div className="cst-row">
                    ...
                    <div>
                      <span className={`cst-status ${s.cls}`}>{s.label}</span>
                    </div>
                    <div>
                      {c.response_count > 0
                    ...
                    <div>
                      <button
                        ...
                        onClick={() => toggleDetail(c.complaint_id)}
                      >
                        {isOpen ? "▲ Hide" : "▼ View"}
                      </button>
                    </div>
                  ...
                  {isOpen && (
                    <div className="cst-detail-panel">
                      {detailLoading && (
                        <div className="cst-loading">Loading details…</div>
                      )}
                      {detail && (
                        <>
                          ...
                          <div className="cst-responses">
                            ...
                            {detail.responses.map((r) => (
                              <div
                                key={r.response_id}
                                className="cst-response-bubble"
                              >
                                <div className="cst-response-meta">
                                  <span className="cst-response-author">
                                    {r.gn_name || "GN Officer"}
                                  </span>
                                  <span className="cst-response-date">
