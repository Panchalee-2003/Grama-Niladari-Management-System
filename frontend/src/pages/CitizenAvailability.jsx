    ...
    <div className="cd-page">
      ...
      <nav className="cd-nav">
        ...
        <Link
          ...
          to="/availability"
          style={{ borderBottom: "3px solid #0C7A3B" }}
        >
          <IconCalendar />
      ...
      <div
        className="cd-main"
        style={{ padding: "20px 40px", color: "#1f1f1f" }}
      >
        <h2 style={{ color: "#1f1f1f", marginBottom: "15px" }}>
          {t("availability.title")}
        </h2>
        <p style={{ color: "#333", marginBottom: "30px" }}>
          Check the GN's availability before visiting the office to avoid
          inconvenience.
        </p>
        ...
        <div style={{ display: "flex", gap: "20px", alignItems: "flex-start" }}>
          ...
          >
            ...
            <div className="cal-legend">
              ...
              <span className="cal-legend-item">
                <span className="cal-dot dot-field"></span> Field
              </span>
              <span className="cal-legend-item">
                <span className="cal-dot dot-unavail"></span> Off
              </span>
            </div>
          ...
          <div style={{ flex: 1, position: "sticky", top: "20px" }}>
            {selectedDateDetails ? (
              ...
              >
                ...
                >
                  Date Details: {selectedDateDetails.date}
                </h3>
                ...
                {selectedDateDetails.start && (
                  <div style={{ marginBottom: "15px" }}>
                    ...
                    <span style={{ fontSize: "1rem", color: "#444" }}>
                      {selectedDateDetails.start.substring(0, 5)} to{" "}
                      {selectedDateDetails.end?.substring(0, 5)}
                    </span>
                  </div>
                )}
                <div>
              ...
              >
                ...
                <p>
                  Click on any date in the calendar to see the Grama Niladhari's
